...
function About() {
  return (
    <>
      <Navbar />
      <div className="bg-[url('https://res.cloudinary.com/dol5ar3iv/image/upload/v1702967623/fotofreaks_iitism_1675510867_3030727283148499964_5457821429_e2sk8e.jpg')] jusitfy-center items-center mt-5 h-full w-full">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center flex flex-col sm:flex-row justify-center items-center lg:py-16 mx-10">
          <motion.div
            //   ref={scope}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <p className="text-white">
              ...
              departments across various technical disciplines. ABOUT US
        ...
        <div>
          <motion.div
            ...
            transition={{ duration: 1 }}
            className=" mx-[6vw] md:mx-[10vw] flex justify-center items-center bg-white/40 backdrop-blur-md border border-gray-200 rounded-lg shadow"
          >
